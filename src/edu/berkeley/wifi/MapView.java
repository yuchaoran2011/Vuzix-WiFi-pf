...
public class MapView extends View {
    ...
    protected void onDraw(Canvas canvas) {
	    ...
	    for (String mapline : maplines) {
	    	...
	    	canvas.drawLine(Float.valueOf(coords[0])*0.2f+10.0f, //15
	    					Float.valueOf(coords[1])*0.2f+45.0f, //5
	    					Float.valueOf(coords[2])*0.2f+10.0f, 
	    					Float.valueOf(coords[3])*0.2f+45.0f, 
	    					mPaint);
	    	}
	    this.gotPosition = true;
